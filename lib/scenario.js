...
// view2.getUint8();
  ...
  for (i=0; i<unitSections; i++) {
    ...
    for (j=0; j<unitCount; j++) {
      ...
      unit.x = view2.getFloat32();
      unit.y = view2.getFloat32();

      view2.getFloat32(); // unknown

      unit.id = view2.getUint32();
      unit.type = view2.getUint16();

      view2.getUint8(); // unknown

      unit.rotation = view2.getFloat32();

      // NOT IN 1.0c
      // unit.animFrame = view2.getUint16();
      // unit.garrisonedIn = view2.getUint32();
